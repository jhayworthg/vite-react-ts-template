...
type SmallDrawerFooterProps = {
  avatarUrl?: string;
  displayThemeToggle?: boolean;
}

function SmallDrawerFooter(props: SmallDrawerFooterProps) {
  ...
  return (
    ...
    >
      <Group grow position='apart' align='center' style={{padding: '0.6rem 0.8rem 2rem 0.8rem'}}>
        {props.avatarUrl && (
          <Avatar 
            src={props.avatarUrl}
            radius='xl'
